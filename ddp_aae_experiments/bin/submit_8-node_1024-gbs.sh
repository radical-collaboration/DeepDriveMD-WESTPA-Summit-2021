#!/bin/bash
#SBATCH -J 8-node_1024-gbs         # Job name
#SBATCH -o 8-node_1024-gbs_%j.out  # Name of stdout output file
#SBATCH -e 8-node_1024-gbs_%j.err  # Name of stderr error file
...
output_path="/scratch/06079/tg853783/ddmd/runs/ddp_aae_experiments/8-node_1024-gbs"
...
# Launch MPI code ...
ibrun -n 32 ${bash_script} ${python_exe} ${train_script} "-c" ${config_file} "--output_path" ${output_path} "--data_path" ${tmp_data_path}
