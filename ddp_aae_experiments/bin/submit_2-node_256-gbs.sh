#!/bin/bash
#SBATCH -J 2-node_256-gbs          # Job name
#SBATCH -o 2-node_256-gbs_%j.out   # Name of stdout output file
#SBATCH -e 2-node_256-gbs_%j.err   # Name of stderr error file
...
# Launch MPI code ...
ibrun -n 8 ${bash_script} ${python_exe} ${train_script} "-c" ${config_file} "--output_path" ${output_path} "--data_path" ${tmp_data_path}
