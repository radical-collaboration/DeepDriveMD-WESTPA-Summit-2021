#!/bin/bash
#SBATCH -J 2-gpu_64-gbs            # Job name
#SBATCH -o 2-gpu_64-gbs_%j.out     # Name of stdout output file
#SBATCH -e 2-gpu_64-gbs_%j.err     # Name of stderr error file
...
output_path="/scratch/06079/tg853783/ddmd/runs/ddp_aae_experiments/2-gpu_64-gbs"
